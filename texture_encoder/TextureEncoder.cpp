...
{
    static constexpr cuttlefish::Texture::Quality qualities[] = {
        cuttlefish::Texture::Quality::Lowest,
        cuttlefish::Texture::Quality::Low,
        cuttlefish::Texture::Quality::Normal,
        cuttlefish::Texture::Quality::High,
        cuttlefish::Texture::Quality::Highest
    };
    return qualities[std::clamp(quality, 1, 5) - 1];
}
...
EXPORT cuttlefish::Texture* LoadTextureFromFile(const char* path)
{
...
EXPORT cuttlefish::Texture* LoadTextureFromBuffer(const void* data, int size, int width, int height)
{
    cuttlefish::Image tmpImage;
